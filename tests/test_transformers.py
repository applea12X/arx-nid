...
class TestRollingStats:
    ...
    def test_multiple_stats(self, sample_flow_data):
        ...
        expected_cols = [
            'orig_bytes_mean_5s', 'orig_bytes_std_5s', 'orig_bytes_count_5s',
            'resp_bytes_mean_5s', 'resp_bytes_std_5s', 'resp_bytes_count_5s'
        ]
    ...
    def test_empty_dataframe(self):
        ...
        empty_df = pd.DataFrame(columns=['ts', 'id.orig_h', 'id.resp_h', 'orig_bytes', 'resp_bytes'])
...
class TestFlowFeatures:
    ...
    def test_derived_features(self, sample_flow_data):
        ...
        expected_features = [
            'total_bytes', 'flow_ratio', 'total_pkts', 'pkt_size_avg',
            'orig_rate', 'resp_rate', 'byte_asymmetry', 'pkt_asymmetry'
        ]
    ...
    def test_ratio_calculations(self, sample_flow_data):
        ...
        pd.testing.assert_series_equal(result['total_bytes'], expected_total, check_names=False)
...
class TestCategoricalEncoder:
    ...
    def test_basic_encoding(self, sample_flow_data):
        ...
        encoded_cols = [col for col in result.columns if col.startswith(('proto_', 'service_', 'conn_state_'))]
