#!/usr/bin/env python3
"""
Download HiTar-2024 and verify checksum.
Usage: python download_hitar.py --out data/raw
"""
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(description="Download HiTar-2024 dataset")
    p.add_argument("--out", default="data/raw", help="Output directory")
    args = p.parse_args()
    main("hitar-2024", args.out)
