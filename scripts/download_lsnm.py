#!/usr/bin/env python3
"""
Download LSNM-2024 and verify checksum.
Usage: python download_lsnm.py --out data/raw
"""
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(description="Download LSNM-2024 dataset")
    p.add_argument("--out", default="data/raw", help="Output directory")
    args = p.parse_args()
    main("lsnm-2024", args.out)
